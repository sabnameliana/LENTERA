...
<head>
    ...
    <style>
        * {
        ...
        :root {
            --primary: #8B5A2B; /* Warna cokelat khas Lentera */
            --secondary: #E6C280;
            --dark: #2C1E11;
            --light: #FDFBF7;
        }
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-img">
            <img src="https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?q=80&w=600" alt="Aktivitas Sanggar">
        </div>
    </section>
    ...
    <section class="program" id="kelas">
        ...
        <div class="grid-kelas">
            <?php
            // Otomatis mengambil data kelas dari database biar dinamis
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 40px; justify-content: space-between;">
            ...
            <div style="flex: 1; min-width: 280px;">
                ...
                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    ...
                    <p style="color: #555; line-height: 1.5;">Jl. Kelinci Raya No. 12, Kel. Pandean Lamper, Kec. Semarang Selatan, Kota Semarang</p>
                </div>

                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    <i class="fa-brands fa-whatsapp" style="font-size: 1.3rem; color: #8B5A2B; width: 25px;"></i>
                    <p style="color: #555;">0812-3775-4949 (Admin Lentera)</p>
                </div>

                <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                    <i class="fa-solid fa-envelope" style="font-size: 1.3rem; color: #8B5A2B; width: 25px;"></i>
                    <p style="color: #555;">sanggarlentera.smg@gmail.com</p>
                </div>
            ...
            <div style="flex: 1; min-width: 300px; height: 250px; border-radius: 15px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126748.56347494447!2d110.34829841443657!3d-7.015738166542456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708b4d3bd45e99%3A0xa16f7bc2611eedc1!2sSemarang%2C%20Kota%20Semarang%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid" 
...
<a href="https://wa.me/6281237754949?text=Halo%20Admin%20Sanggar%20Lentera,%20saya%20ingin%20tanya%20seputar%20pendaftaran%20kelas%20seni." 
       target="_blank" 
